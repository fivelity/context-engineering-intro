<script>import { addYears, subYears, isSameYear, isWithinInterval, startOfYear, endOfYear, } from 'date-fns';
...
export let disabledYears = undefined; // TODO: Improve types - See isYearDisabled
$: minYear =
    minYear ??
        (minDate
            ? minDate.getFullYear()
