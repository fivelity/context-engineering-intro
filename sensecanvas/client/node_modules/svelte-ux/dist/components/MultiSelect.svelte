<script>import { getComponentTheme } from './theme';
...
export let options;
export let value = [];
export let indeterminateSelected = [];
...
export let cancelButtonProps = undefined;
export let applyButtonProps = undefined;
export let classes = {};
...
$: [selectedOptions, unselectedOptions] = partition(options, (x) => value.includes(get(x, valueProp)));
// Filter by search text
function applyFilter(option, searchText) {
    if (searchText) {
