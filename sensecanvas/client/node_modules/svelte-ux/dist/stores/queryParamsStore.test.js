...
describe('getParamConfig', () => {
    ...
    it('json encode', () => {
        ...
        const actual = encode(original);
        expect(actual).toEqual('{"number":1234,"string":"example","bool":true,"date":"1982-03-30T05:00:00.000Z"}');
    });
    ...
    it('object encode', () => {
        ...
        const actual = encode(original);
        expect(actual).toEqual('number-1234_string-"example"_bool-true_date-"1982-03-30T05:00:00.000Z"');
    });
