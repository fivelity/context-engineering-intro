 ...
 */
export declare const longpress: Action<HTMLElement, number>;
type MovableOptions = {
    /**
 ...
 */
export declare const movable: Action<HTMLElement, MovableOptions>;
/** Set relative mouse coordinates as --x/--y CSS variables */
export declare const mouseCoords: Action<HTMLElement, HTMLElement>;
export {};
