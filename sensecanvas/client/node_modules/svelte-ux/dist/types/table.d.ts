...
export type ResolvePropType<TData, T> = T | null | undefined | ((context: ResolveContext<TData>) => T | null | undefined);
export type ColumnDef<TData = any> = {
    ...
    style?: {
        th?: ResolvePropType<TData, string | {
            [property: string]: string;
        }>;
        td?: ResolvePropType<TData, string | {
            [property: string]: string;
        }>;
    };
    classes?: {
    ...
    dataBackground?: Partial<DataBackgroundOptions> | ((context: ResolveContext<TData>) => Partial<DataBackgroundOptions>);
